...
import 'package:pts/pages/search/widgets/searchbar.dart';
import 'package:pts/widgets/widgets_export.dart';
import 'package:sliding_up_panel/sliding_up_panel.dart';
import 'package:table_calendar/table_calendar.dart';

class SearchPageLauncher extends StatelessWidget {
  const SearchPageLauncher({Key? key}) : super(key: key);
...
class SearchPage extends StatefulWidget {
  ...
  SearchPage({Key? key, this.last, this.onPop}) : super(key: key);
          ...
          Padding(
            ...
            child: TextButton(
              ...
              onPressed: () => Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => MapViewPage())),
            ),
          ),
          Text(
