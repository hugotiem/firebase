...
import 'package:pts/pages/home/subpage/geolocalisation_page.dart';
import 'package:pts/pages/search/widgets/search_widgets_exports.dart';
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            image: DecorationImage(
              fit: BoxFit.cover,
              image: AssetImage('assets/cityview1.png'),
            ),
          ...
          child: SearchBar(
              ...
              onTap: () {
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => SearchPageLauncher(),
